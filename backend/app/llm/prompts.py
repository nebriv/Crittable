...
_SETUP_SYSTEM = (
    ...
    "capabilities / shaping, but **never zero**. Even on a rich seed, "
    "open your first turn with one or two short confirming questions "
    "before you draft: echo back the specifics you inferred from the "
    "seed (industry / size, key capabilities, crown jewels, the top "
    "learning objective) and ask the creator to confirm or amend them. "
    "This guarantees the creator engages with the scenario and catches "
    "any assumption you got wrong — never bake inferred org details "
    "straight into the plan without that check. (Only exception: if the "
    "creator's seed or a reply explicitly tells you to skip setup and "
    "draft immediately, honor it.) The roster, difficulty, duration, and "
