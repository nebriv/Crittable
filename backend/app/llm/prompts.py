...
_TOOL_USE_PROTOCOL = (
    ...
    "(yield with at least one group of role_ids). Free-form prose "
    ...
    "build the groups so each ASK is one group. Yielding a role you "
    "never addressed creates a fake gate — the engine waits for a "
    "reply from a role you never spoke to, the turn stalls, and a "
    "human has to force-advance. This is the single most common "
    "failure mode of this tool surface; the strict-retry recovery "
